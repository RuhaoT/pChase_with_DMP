...
int main(int argc, char* argv[]) {
    ...
    //parse the arguments, initialize experiment
	Experiment e;
    ...
    //print the results
    //e contains the experiment parameters
    //ops is the number of operations per chain
    //seconds is the time per chain
    //clk_res is the timer resolution
